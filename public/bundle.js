...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GetWeatherMsg = __webpack_require__(220);
	...
	var Weather = React.createClass({
		...
		handleIds: function handleIds(id) {
			var _this = this;
			...
			fetch(baseURL).then(function (response) {
				...
				console.log(error);_this.setState({ showFetchLoader: false });
			});
		},
		render: function render() {
			...
			var _state = this.state,
			    id = _state.id,
			    msg = _state.msg,
			    showFetchLoader = _state.showFetchLoader;
			...
			function renderMessage() {
				if (showFetchLoader) {
					...
					return React.createElement(GetWeatherMsg, { id: id, msg: msg });
				}
			}
			...
			return React.createElement(
				'div',
				null,
				React.createElement(GetWeatherForm, { getData: this.handleIds }),
				renderMessage()
			);
		}
	});
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { type: 'text', ref: 'id', placeholder: 'Enter ref id' }),
					React.createElement(
						'button',
						null,
						'Submit'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GetWeatherMsg = function GetWeatherMsg(props) {
		return React.createElement(
			'div',
			null,
			React.createElement(
